...
function showForm($type){
    ...
    <?php if ($type=="configInfo"){
        ...
        <div class="container">
                ...
                <p style="font-size:10px">Made with 🖤 in <a target="_blank" href="https://github.com/deltashopsiavash/deltabotvps">delta</a></p>
            </form>
        </div>
    ...
    elseif($type=="unknown"){ ?>
        ...
        <div class="container">
            <form id="contact" action="search.php" method="get">
                ...
                <p style="font-size:13px">Made with 🖤 in <a target="_blank" href="https://github.com/deltashopsiavash/deltabotvps">delta</a></p>
            </form>
        </div>
        <br>
        <br>

...
# -------------------------
    ...
    async def get_order(self, order_id: int, user_id: Optional[int] = None) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "manual_details": r[12],
            "billing_mode": r[13],
            "price_monthly_irt": int(r[14] or 0),
            "price_hourly_irt": int(r[15] or 0),
            "traffic_limit_gb": int(r[16] or 0),
            "traffic_used_gb": float(r[17] or 0.0),
            "traffic_last_ts": int(r[18] or 0),
            "status": r[19],
            "purchased_at": int(r[20] or 0),
            "expires_at": int(r[21] or 0),
            "last_billed_hour": int(r[22] or 0),
            "last_hourly_charge_at": int(r[23] or 0),
            "last_warn_at": int(r[24] or 0),
            "suspended_at": int(r[25] or 0),
            "delete_at": int(r[26] or 0),
        }

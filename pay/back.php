...
🌐 subscription : <code>$subLink</code>
            ...
            if(isset($GLOBALS['currentBotInstanceId']) && !empty($GLOBALS['currentBotInstanceId'])){
                $bid = (int)$GLOBALS['currentBotInstanceId'];
                $cand = "../settings/qrcodes/qr_rb{$bid}.jpg";
                if(is_file($cand)) $bgPath = $cand;
            }
            if(!is_file($bgPath)) $bgPath = "../settings/QRCode.jpg";

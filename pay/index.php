...
if(mysqli_num_rows($payInfo)==0){
    ...
    $offerPaymentError = '';
    if(!timedOfferEnsurePayReservation($payParam, 7200, $offerPaymentError)){
        showForm('مهلت یا موجودی این پیشنهاد ویژه تمام شده است. لطفاً از داخل ربات فاکتور جدید بسازید.');
        exit();
    }

<p align="center">
  <a href="https://github.com/deltashopsiavash/deltabotvps" target="_blank" rel="noopener noreferrer">
    <picture>
...
<p align="center">
Easy to sell with <a href="https://github.com/deltashopsiavash/deltabotvps">deltabotvps</a> easy install with few clicks
</p>

<p align="center">
delta is a powerful and professional robot that supports several types of panels and is the best option for sale, supports most protocols and has easy installation. This robot is optimized for the dear people of Iran. It is a great alternative to selling so that you can get to work.
</p>


<div align=center>

[![Telegram Channel](https://img.shields.io/endpoint?label=Channel&style=flat-square&url=https%3A%2F%2Ftg.sumanjay.workers.dev%2Fdeltach&color=blue)](https://telegram.dog/deltach)
[![Telegram Group](https://img.shields.io/endpoint?color=neon&label=Support%20Group&style=flat-square&url=https%3A%2F%2Ftg.sumanjay.workers.dev%2Fdeltadev)](https://telegram.dog/deltadev)
<img src="https://img.shields.io/github/license/deltashopsiavash/deltabotvps?style=flat-square" />
<img src="https://img.shields.io/github/v/release/deltashopsiavash/deltabotvps.svg" />
<!-- <img src="https://visitor-badge.glitch.me/badge?page_id=deltadev.deltadev" />
 -->
</div>
...
<br>
    <a align="center">
        <img src="https://github.com/deltashopsiavash/deltabotvps/assets/27927279/f6635ea5-ab26-4c64-a7b8-952203f79763" />
    </a>     
<br>
<br>
...
```
bash <(curl -s https://raw.githubusercontent.com/deltashopsiavash/deltabotvps/main/delta.sh)
```
...
- Very good, the installation message ( ✅ The delta bot has been successfully installed! ) is sent to the bot

<br>
<br>

## Update bot - Update panel - backup - remove delta

- With every update and backup, a notification is sent to the manager robot
```
bash <(curl -s https://raw.githubusercontent.com/deltashopsiavash/deltabotvps/main/update.sh)
```
...
## Contact Developer
💎 Group: https://t.me/deltadev
💎 Channel: https://t.me/deltach
...
[![Stargazers over time](https://starchart.cc/deltashopsiavash/deltabotvps.svg)](https://starchart.cc/deltashopsiavash/deltabotvps)

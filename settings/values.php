...
⚠️در این شرایط اشتراک ممکنه سرعتش کند باشه و برای اینستا و بعضی سایت ها ضعیف کار کنه اما برای تلگرام و واتساپ بدون مشکل هست⚠️
...
یکی از پلن هارو انتخاب کن و برو برای پرداختش 🤲 🕋", 
    ...
    'enter_account_amount' => "♻️ تعداد اکانت درخواستی رو وارد کن (از 1 تا 10 عدد):

⚠️ | فقط اعداد انگلیسی بین 1 تا 10 قابل قبول هستند",
...
$buttonValues = [
    ...
    'buy_single'=>'➕ خرید تکی',
    'buy_group'=>'👥 خرید گروهی',
    'buy_again_last'=>'🔁 خرید مجدد آخرین سرویس',

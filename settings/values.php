...
$mainValues = [
    'banned' => '❌ شما بلاک شدید و امکان استفاده از ربات را ندارید.',
    ...
    'increase_wallet_cart_to_cart'=>"جهت خرید و یا افزایش موجودی هزینه  را به شماره‌ی کارت زیر واریز کنید 👇🏻

        ==================== 
      🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME
        ====================

پس از واریز در صورت امکان عکس رسید را با زدن دکمه ارسال عکس واریزی ارسال نمایید در صورتی که اینترنت شما ضعیف هست میتوانید از دکمه ارسال پیامک واریزی استفاده نمایید به جای ارسال عکس⚠️⚠️
...
⚠️تایید سفارش بین 1 دقیقه الی 2 ساعت طول میکشه اگر از 2 ساعت گذشت و سفارش شما تایید نشد به پشتیبانی اطلاع دهید لطفا قبل از گذشت این زمان به هیچ عنوان جهت تایید سفارش به پشتیبانی پیام ندهید⚠️",
    'please_send_only_image'=>"❌سفارش شما لغو شد لطفا مراحل خرید را از اول طی کنید سپس اطلاعات واریزی را بفرستید❌",
...
",
    ...
    'buy_account_cart_to_cart'=>"جهت خرید و یا افزایش موجودی هزینه  را به شماره‌ی کارت زیر واریز کنید 👇🏻
...
‼️مسئولیت واریز اشتباهی با شماست.
💵بعد از تایید پرداختتون توسط ادمین کیف پول شما شارژ خواهد شد و در صورتی که سفارشی داشته باشین انجام خواهد شد",
    'renew_ccount_cart_to_cart'=>"جهت خرید و یا افزایش موجودی هزینه  را به شماره‌ی کارت زیر واریز کنید 👇🏻
...
",
    ...
    'start_message'=>'سلااام به ربات دلتا خوش اومدی 🫡🌸
...
⚠️ | نکته: در صورت وارد کردن به مقدار بالا احتمالا اکانت ساخته نشود و پنل x-ui گیر کند",
    ...
    'buy_subscription_detail'=>"🧾 فاکتور پرداخت
...
➖➖➖➖➖➖➖
💎 قیمت پلن: BASE-PRICE
🎁 تخفیف شما: DISCOUNT-PERCENT٪ (DISCOUNT-AMOUNT تومان)
✅ مبلغ نهایی: FINAL-PRICE
➖➖➖➖➖➖➖
💰 موجودی فعلی شما: CURRENT-WALLET تومان
💳 موجودی پس از خرید: WALLET-AFTER تومان
➖➖➖➖➖➖➖
📃 توضیحات:
DESCRIPTION
➖➖➖➖➖➖➖",
    'buy_much_subscription_detail'=>"🧾 فاکتور پرداخت
...
$buttonValues = [
    ...
    'reseller_bot_shop'=>'🤖 ربات نمایندگی',
    'my_reseller_bots'=>'🤖 ربات های من',
    ...
    ,'cloud_vps_buy'=>'خرید سرور ابری'
    ,'cloud_vps_manage'=>'مدیریت سرور های ابری'
];
?>

...
$mainValues = [
    ...
    'increase_wallet_prompt'=>"🙂 عزیزم مقدار شارژ مورد نظر خود را به تومان وارد کن (بیشتر از 5000 تومان)",
...
⚠️تایید سفارش بین 1 دقیقه الی 2 ساعت طول میکشه اگر از 2 ساعت گذشت و سفارش شما تایید نشد به پشتیبانی اطلاع دهید لطفا قبل از گذشت این ساعت به هیچ عنوان جهت تایید سفارش به پشتیبانی پیام ندهید⚠️",
...
⚠️ | نکته: در صورت وارد کردن به مقدار بالا  اکانت ساخته نمیشود و پاز ربات به مدت چند ساعتی محدود خواهید شد",

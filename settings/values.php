...
⚠️اگر کارت محدودیت داشت مجدد مراحل دریافت شماره کارت از اول برید تا شماره کارت جدید دریافت کنید و یا از برنامه آپ استفاده نکنید⚠️
...
❌⚠️لطفا قبل خرید حتما اکانت تست دریافت کنید در صورتی که تست کار کنه اشتراک اصلی هم کار میکنه اندروید اگه کار نکرد با برنامه npv بزنید⚠️❌
...
",
    'bot_is_updating'=> "ربات خاموش است❌موقتا جهت خرید به پشتیبانی مراجعه نمایید: @delta_vpn12",

...
if($giftList->num_rows>0){
    ...
    if($offset == 0) sendToAdmins("عملیات هدیه حجم و زمان سرور $serverName شروع شد", null, null);
    ...
    if($found == false){
        ...
        sendToAdmins("عملیات هدیه حجم و زمان سرور $serverName به اتمام رسید", null, null);
    }
}

...
CREATE TABLE `orders_list` (
  ...
  `expired_warned_at` int NOT NULL DEFAULT '0',
  `delete_after` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `reseller_bots` (
  ...
  `volume_quota_limit` int DEFAULT NULL,
...
CREATE TABLE `server_config` (
  ...
  `sub_base_url` varchar(255) DEFAULT NULL,
  `ip` text NOT NULL,
...
CREATE TABLE `server_plans` (
  ...
  `days` float NOT NULL,
  `volume` float NOT NULL,
  `quota_charge_volume` float NOT NULL DEFAULT '0',
  `show_full_renew` tinyint(1) NOT NULL DEFAULT '1',
  `secret_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
INSERT INTO `setting` VALUES (1,'BOT_STATES','{\"sellState\":\"on\",\"botState\":\"on\",\"subLinkState\":\"on\",\"volumeWebState\":\"on\",\"agencyState\":\"on\",\"testAccount\":\"on\",\"cartToCartAutoAcceptState\":\"off\",\"cartToCartAutoAcceptTime\":\"1\",\"cartToCartState\":\"on\",\"walletState\":\"on\"}'),(2,'PAYMENT_KEYS','{\"bankAccount\":\"6262626212111212\",\"holderName\":\"name\"}');
...
CREATE TABLE `users` (
  ...
  `pg_renew_suggestion` tinyint(1) NOT NULL DEFAULT '1',
  `pg_expiry_alerts` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'7108082722','...',' ندارد ','0',0,'1771782261',NULL,NULL,'none',NULL,0,NULL,'',0,NULL,0,NULL,1,1),(2,'6668176130','پشتیبانی دلتا وی پی ان','delta_vpn12','0',0,'1771782273',NULL,NULL,'none',NULL,0,'sent','',2,NULL,0,'{\"count\":8,\"date\":1771782870}',1,1);

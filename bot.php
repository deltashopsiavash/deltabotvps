...
$acc_text .= xuiBuildOrderLinksText($botState, $botUrl, $uniqid, $subLink);
            if(isset($accountCount) && isset($uid) && (int)$accountCount > 1){
                sendMessage($acc_text, json_encode(['inline_keyboard'=>[[['text'=>$buttonValues['back_to_main'],'callback_data'=>"mainMenu"]]]]), "HTML", $uid);
                continue;
            }

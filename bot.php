...
برای این که Device ID هر گوشی توی برنامه متفاوت است و با این کد میتوان اشتراک رو قفل کرد جهت تک کاربره شدن اشتراک و هیچ سود و یا خطرات دیگری ندارد این کد فقط صرفا جهت قفل اشتراک روی همان دستگاه است✅", $cancelKey, 'HTML');
    ...
    if(isset($accountCount)){
        ...
        $invoiceSeparator='●-●-●-●-●-●-●-●-●-●-●-●-●-●-●-●-●-●-●-';
        $invoicePrice=number_format((int)$price).' تومان';
        $msg="🧾 فاکتور پیشنهاد ویژه🔥💥\n\n"
            ."{$invoiceSeparator}\n\n"
            ."📦 پلن: {$safeName}\n"
            ."🔋 حجم: ".($respd['volume']??0)." گیگابایت\n"
            ."⏰ مدت: ".($respd['days']??0)." روز\n"
            ."🏷 تخفیف طرح: {$offerPercent}٪\n"
            ."✅ مبلغ نهایی قابل پرداخت: {$invoicePrice}\n\n"
            ."{$invoiceSeparator}\n\n"
            ."💳 روش پرداخت: فقط موجودی کیف پول\n\n"
            ."⚠️جهت خرید باید حتما کیف پولتون موجودی داشته باشه و با پرداخت موجودی خرید تکمیل کنید⚠️\n\n"
            ."{$invoiceSeparator}\n\n"
            ."💰 موجودی فعلی: ".number_format($currentWallet)." تومان\n"

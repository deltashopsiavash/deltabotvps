...
$connection->query("CREATE TABLE IF NOT EXISTS `pays` (
    ...
    `special_offer_qty` INT NOT NULL DEFAULT 0,
...
$connection->query("CREATE TABLE `users` (
  ...
  `approval_inviter_input` varchar(190) DEFAULT NULL,
  `approval_inviter_userid` bigint(20) DEFAULT NULL,
  `approval_inviter_username` varchar(100) DEFAULT NULL,
  `approval_requested_at` int(11) NOT NULL DEFAULT 0,
  `approval_updated_at` int(11) NOT NULL DEFAULT 0,

...
function getMainKeys(){
    ...
    // VPSBot integration entry point (cloud servers)
    // Note: this button is always visible; access control is handled inside VPSBot.
    $mainKeys = array_merge($mainKeys, [
        [['text'=>$buttonValues['cloud_server_buy'],'callback_data'=>'cloudMenu']],
    ]);
    $mainKeys = array_merge($mainKeys,[
        (
...
function getAdminKeys(){
    ...
    // VPSBot integration (cloud servers admin)
    $rows[] = [
        ['text'=>$buttonValues['cloud_server_manage'],'callback_data'=>"cloudAdmin"],
        ['text'=>' ','callback_data'=>"deltach"],
    ];

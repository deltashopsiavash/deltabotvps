...
require_once __DIR__ . "/settings/timed_offers.php";
ensureTimedOffersSchema();
...
function getMainKeys(){
    ...
    $canSeeTimedOffers = ($botState['sellState'] == "on" || $from_id == $admin || $userInfo['isAdmin'] == true);
    if($canSeeTimedOffers && function_exists('timedOfferHasActive') && timedOfferHasActive()){
        $mainKeys[] = [['text'=>'🔥 پیشنهاد امروز','callback_data'=>'timedOffers']];
    }
    $mainKeys = array_merge($mainKeys,[
        (
...
function getAdminKeys(){
    ...
    $rows[] = [
        ['text'=>'🔥 پیشنهاد ویژه و فروش محدود','callback_data'=>'offerAdmin'],
    ];

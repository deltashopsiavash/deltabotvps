...
function xuiGetBotStateDefaults(){
    return [
        'requirePhone' => 'off',
        ...
        'nowPaymentOther' => 'on',
        'walletState' => 'on',
        'rewardChannel' => '@deltadev',
        'lockChannel' => '@deltach',
        'changeProtocolState' => null,
        'renewAccountState' => null,
        ...
        'volumeWebState' => 'on',
        'configLinkState' => 'on',
        'renewConfigLinkState' => 'off',
        'updateConfigLinkState' => 'off',
        'qrConfigState' => 'on',
        'qrSubState' => 'off',
        ...
        'testAccount' => 'on',
        'agencyState' => 'on',
        'cartToCartAutoAcceptState' => 'off',
        'cartToCartAutoAcceptType' => '0',
        'cartToCartAutoAcceptTime' => '10'
    ];
}
function xuiHydrateBotState($botState, $persist = true){
    global $connection;
    if(!is_array($botState)) $botState = [];
    $defaults = xuiGetBotStateDefaults();
    $changed = false;
    foreach($defaults as $key => $value){
        if(!array_key_exists($key, $botState)){
            $botState[$key] = $value;
            $changed = true;
        }
    }
    if($persist && $changed && $connection && !$connection->connect_error){
...
$botState = xuiHydrateBotState($botState);
$stmt->close();
